...
var _ = Describe("DeaApps", func() {
	...
	JustBeforeEach(func() {
		apps, err = commands.DeaApps(fakeRequestFactory.Spy, fakeCloudControllerClient, fakeResponseParser, fakePaginatedParser)
	})
			...
			Context("when parsing for the number of pages succeeds", func() {
				...
				Context("when there's more than one page", func() {
					...
					Context("when the parsing succeeds", func() {
						...
						It("returns a list of dea applications", func() {
